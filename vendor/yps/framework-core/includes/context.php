...
use YPS\Framework\String\v020_769_691\String_Helper;
...
class Context {
	...
	public function init_framework(){
		$composer			= file_get_contents($this->helper->get_plugin_path($this->get_plugin_code(), "composer.json"));
		$framework_mapping	= file_get_contents($this->helper->get_plugin_path($this->get_plugin_code(), "autoload/framework_mapping.json"));
		$version			= file_get_contents($this->helper->get_plugin_path($this->get_plugin_code(), "autoload/version.json"));

		$composer					= json_decode($composer, true);
		$framework_mapping			= json_decode($framework_mapping, true);
		$version					= json_decode($version, true);

		foreach($framework_mapping as $framework_composer_name => $framework_name){
			$framework_version		= $version[$framework_composer_name];
