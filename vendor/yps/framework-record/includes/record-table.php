...
class Record_Table extends Base {
    ...
    /**
     * @var \YPS\Framework\Record\v020_769_691\Record_Form
     */
    public $record_form;
            ...
            foreach($this->header as $header_key => $header_label){
                if($header_key == 'actions' && $this->show_actions_column == true){
                    ...
                    if($this->show_actions_edit_button == true){
                        $actions['edit']          =  "<a class='btn btn-primary' href='{$this->record_config->get_edit_url($id)}'>" . 
                                __('Edit', 'yps-framework-core') . 
                                "</a>";
                    }
                    
                    if($this->show_actions_delete_button == true){
                        $actions['delete']          = "<a class='yps-record-delete btn btn-danger' href='{$this->record_config->get_delete_url($id)}'>Delete</a>";
                    }
